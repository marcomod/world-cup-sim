...
import {
  buildOfficialSnapshotOrchestrationStatus as buildOfficialSnapshotOrchestrationStatusFromArtifacts,
  type OfficialArtifactPaths,
  type OfficialOrchestrationStatus,
} from "./officialOrchestrationStatus.ts";
...
export function buildOfficialSnapshotOrchestrationStatus(
  result: OfficialSnapshotBuildResult,
  artifactPaths?: OfficialArtifactPaths,
): OfficialOrchestrationStatus {
  return buildOfficialSnapshotOrchestrationStatusFromArtifacts({
...
export function writeOfficialSnapshotArtifacts(result: OfficialSnapshotBuildResult): void {
  ...
  const orchestrationStatus = buildOfficialSnapshotOrchestrationStatus(result);
  ...
  writeJsonAtomically(OFFICIAL_SNAPSHOT_ORCHESTRATION_STATUS_FILE, orchestrationStatus);
  writeFileSync(
